...
/// </summary>
public class PuzzleGameNetworkRoomManager : NetworkRoomManager
{
    // Overrides the base singleton so we don't
    // have to cast to this type everywhere.
    public static new PuzzleGameNetworkRoomManager singleton => (PuzzleGameNetworkRoomManager)NetworkRoomManager.singleton;
    ...
    {
        PuzzleGameNetworkRoomPlayer puzzleRoomPlayer = roomPlayer.GetComponent<PuzzleGameNetworkRoomPlayer>();
        puzzleRoomPlayer.RpcDisableCanvas();
    ...
    public override void OnRoomServerPlayersReady()
    {
        ...
        host?.GetComponent<PuzzleGameNetworkRoomPlayer>().SetStartInteractible(true);
    ...
    {
        NetworkRoomPlayer host = roomSlots.SingleOrDefault(roomPlayer => roomPlayer.isLocalPlayer && roomPlayer.isServer);
        host?.GetComponent<PuzzleGameNetworkRoomPlayer>().SetStartInteractible(false);
    }
